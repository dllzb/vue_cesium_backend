define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'cesiummapv/config/index',
                    add_url: 'cesiummapv/config/add',
                    edit_url: 'cesiummapv/config/edit',
                    del_url: 'cesiummapv/config/del',
                    multi_url: 'cesiummapv/config/multi',
                    table: 'cesiummapv_config',
                }
            });
            ...
            $(document).on("click", ".btn-delcfg", function () {
                ...
                Layer.confirm(__('Are you sure you want to delete this item?'), {
                    ...
                    Backend.api.ajax({
                        url: "cesiummapv/config/del?receiver=" + value,
